...
module Oroshi
  class SupplyTypeVariationsControllerTest < ActionDispatch::IntegrationTest
    setup do
    ...
    test 'POST create returns http success with valid params' do
      ...
      post oroshi_supply_type_variations_path,
           params: { oroshi_supply_type_variation: supply_type_variation_attributes }
    end
    ...
    test 'PATCH update returns http success' do
      ...
      patch oroshi_supply_type_variation_path(supply_type_variation),
            params: { oroshi_supply_type_variation: updated_attributes }
      assert_response :success
    end
  end
end
