...
class Oroshi::ProductionRequestTest < ActiveSupport::TestCase
  def setup
  ...
  test "has many supply type variations through product variation" do
    production_request = create(:oroshi_production_request)
    assert_equal production_request.product_variation.supply_type_variations, production_request.supply_type_variations
  end
