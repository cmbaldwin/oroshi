...
class Oroshi::SupplierOrganizationsControllerTest < ActionDispatch::IntegrationTest
  setup do
  ...
  test "POST create returns http success with valid params" do
    ...
    post oroshi_supplier_organizations_path, params: { oroshi_supplier_organization: supplier_organization_attributes }
    assert_response :success
  end
  ...
  test "PATCH update returns http success" do
    ...
    patch oroshi_supplier_organization_path(supplier_organization), params: { oroshi_supplier_organization: updated_attributes }
    assert_response :success
  end
end
