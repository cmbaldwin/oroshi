...
module Oroshi
  class ShippingReceptaclesControllerTest < ActionDispatch::IntegrationTest
    setup do
    ...
    test 'GET index returns http success' do
      get oroshi_shipping_receptacles_path
    ...
    test 'GET edit returns http success' do
      ...
      get edit_oroshi_shipping_receptacle_path(shipping_receptacle)
      assert_response :success
    end

    # GET #new
    test 'GET new returns http success' do
      get new_oroshi_shipping_receptacle_path
      assert_response :success
    end
    ...
    test 'POST create returns http success with valid params' do
      ...
      post oroshi_shipping_receptacles_path, params: { oroshi_shipping_receptacle: shipping_receptacle_attributes }
    end
    ...
    test 'PATCH update returns http success' do
      ...
      patch oroshi_shipping_receptacle_path(shipping_receptacle),
            params: { oroshi_shipping_receptacle: updated_attributes }
      assert_response :success
    end
  end
end
