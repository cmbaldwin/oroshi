...
class CreateOroshiSupplyDateSupplyTypeVariations < ActiveRecord::Migration[7.1]
  def change
    ...
    add_index :oroshi_supply_date_supply_type_variations, %i[supply_date_id supply_type_variation_id], unique: true,
                                                                                                       name: 'index_supply_date_supply_type_variations_on_ids'
    add_index :oroshi_supply_date_supply_type_variations, %i[supply_type_variation_id supply_date_id],
              name: 'index_supply_type_variations_supply_dates_on_ids'
  end
end
