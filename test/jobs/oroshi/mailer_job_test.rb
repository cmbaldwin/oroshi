...
class Oroshi::MailerJobTest < ActiveJob::TestCase
  setup do
    ...
    @invoice = instance_double("Oroshi::Invoice", id: 1, sent_at: nil, save: true, errors: instance_double("ActiveModel::Errors", full_messages: []))
    @supplier_org1 = instance_double("Oroshi::SupplierOrganization", id: 1, entity_name: "Supplier 1", email: "supplier1@example.com")
    @supplier_org2 = instance_double("Oroshi::SupplierOrganization", id: 2, entity_name: "Supplier 2", email: "supplier2@example.com")
  ...
  test "updates message with failure status when email delivery fails" do
    ...
    assert_received(@message, :message=).with("\u30E1\u30FC\u30EB\u306E\u9001\u4FE1\u306B\u5931\u6557\u3057\u307E\u3057\u305F\u3002")
    assert_received(@message, :save)
  end
  ...
  test "logs info about sending to company email when supplier has no email" do
    supplier_org_no_email = instance_double("Oroshi::SupplierOrganization", id: 3, entity_name: "\u76F8\u751F", email: "")
  ...
  test "logs info for all organizations being sent to company when all have no email" do
    supplier_org_no_email1 = instance_double("Oroshi::SupplierOrganization", id: 3, entity_name: "\u76F8\u751F", email: "")
    supplier_org_no_email2 = instance_double("Oroshi::SupplierOrganization", id: 4, entity_name: "\u8D64\u7A42", email: nil)
