...
module Oroshi
  class InvoicePreviewJobTest < ActiveJob::TestCase
    setup do
    ...
    test 'creates OroshiInvoice with correct parameters' do
      ...
      Oroshi::InvoicePreviewJob.perform_now(@start_date, @end_date, @supplier_organization_id, @invoice_format, @layout,
                                            @message.id)
    end
    ...
    test 'parses string dates correctly' do
      ...
      Oroshi::InvoicePreviewJob.perform_now('2025-10-01', '2025-10-31', @supplier_organization_id, @invoice_format,
                                            @layout, @message.id)
    end
