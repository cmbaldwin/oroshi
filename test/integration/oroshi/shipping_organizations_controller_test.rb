...
module Oroshi
  class ShippingOrganizationsControllerTest < ActionDispatch::IntegrationTest
    setup do
    ...
    test 'POST create returns http success with valid params' do
      ...
      post oroshi_shipping_organizations_path,
           params: { oroshi_shipping_organization: shipping_organization_attributes }
      assert_response :success
    end
    ...
    test 'PATCH update returns http success' do
      ...
      patch oroshi_shipping_organization_path(shipping_organization),
            params: { oroshi_shipping_organization: updated_attributes }
      assert_response :success
    end
  end
end
