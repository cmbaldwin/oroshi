...
class Oroshi::SupplyReceptionTimesControllerTest < ActionDispatch::IntegrationTest
  setup do
  ...
  test "POST create returns http success with valid params" do
    ...
    post oroshi_supply_reception_times_path, params: { oroshi_supply_reception_time: supply_reception_time_attributes }
    assert_response :success
  end
  ...
  test "PATCH update returns http success" do
    ...
    patch oroshi_supply_reception_time_path(supply_reception_time), params: { oroshi_supply_reception_time: updated_attributes }
    assert_response :success
  end
end
